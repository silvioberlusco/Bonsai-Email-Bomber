...
Come usare: inserire le email e le password nel file email.txt nel formato email:password.
Servizi supportati: Gmail, Libero, Virgilio, Outlook, Hotmail, Tiscali, Yahoo.
Nota: per alcune caselle (es. Gmail) è necessario usare le App Passwords come password.
Per altri servizi (es. Libero o Virgilio) si può usare la password normale.
"""
def bgui():
    os.system("cls")
